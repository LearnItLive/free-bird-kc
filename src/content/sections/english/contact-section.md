...
description: "Let’s discuss how fractional support can free up your time and move key priorities forward."
...
form:
  emailSubject: "New inquiry from Kelly Comiskey Consulting website"
  submitButton:
    # Refer to the `sharedButton` schema in `src/sections.schema.ts` for all available configuration options (e.g., enable, label, url, hoverEffect, variant, icon, tag, rel, class, target, etc.)
    enable: true
    label: "SEND MESSAGE"
  ...
  inputs:
    ...
    - note: deprecated # info | warning | success | deprecated | hint
      ...
      content: Something went wrong! Please email [kellycomiskey@gmail.com](mailto:kellycomiskey@gmail.com) and we’ll assist you.
---
